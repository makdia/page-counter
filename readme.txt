=== Page Counter ===
Contributors: Makdia Hussain
Tags: page counter, visits, analytics
...
A simple page counter plugin for WordPress.
...
1. Page Counter shortcode example.
...
Page Counter plugin is created by Makdia Hussain.